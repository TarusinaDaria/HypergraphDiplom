using DiplomHypergraph.Domain.Helpers.Guarding;
using DiplomHypergraph.Math.Domain;
using System;
...
namespace DiplomHypergraph.Math.Encryption
{
    public sealed class HomogenousHypergraphEncryptor : ISymmetricCipherAlgorithm
    {
